...
class Nav2Executer(Node):
    def __init__(self):
        ...
        # マーカーパブリッシャー
        self.marker_pub = self.create_publisher(MarkerArray, 'waypoint_markers', qos_profile)
    ...
    def publish_waypoint_markers(self):
        """ウェイポイントマーカーをMarkerArrayとしてパブリッシュする"""
